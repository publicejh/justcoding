...
<script>
  ...
  export default {
    ...
    created () {
      axios.get('https://raw.githubusercontent.com/shanraisshan/EmojiCodeSheet/master/json/string/People.json').then(response => {
        this.emojis = response.data.peoples.people
      }, response => {
        // error callback
      })
    },
